...
BG_IMAGE_FILE_INTRO = "primer.jpg"
    ...
    <div class="overlay">
      ...
      {% if not result or result == 'fail' %}
        ...
        <ol class="action-list">
            ...
            <li>Entrad al wild food y pediros un café.</li>
...
<body>
  <div class="bg">
    <div class="overlay">
      ...
      <p>¡Has resuelto todos los enigmas demostrando tu ingenio! Espero que te guste. Como regalo extra vamos al super rápido a pillar todos los ingredientes necesarios para preparar esa cena tan rica.</p>
      <p>¡¡¡¡Ve a por tu recompensa, te la mereces y TE AMO!!!</p>
    </div>
  </div>
...
def puzzle_7():
    ...
    return render_template_string(TEMPLATE_7_IN_SITU, 
                                  ...
                                  cafe_image_file='top.jpg', # CAMBIA ESTO por tu nombre de archivo real
                                  music_file=MUSIC_FILE)
...
def puzzle_11():
  ...
  ¿En que año se fundó?
  ¿Cuántos leones están de pie? 
  ¿Cuántas mujeres hay arriba levantando las manos? 
